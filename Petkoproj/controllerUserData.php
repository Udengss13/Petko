...
$errors = array(); 
    ...
    if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  {
        ...
        if(count($errors) === 0){
            ...
            $status = "notverified";
            $insert_data = "INSERT INTO usertable (first_name, middle_name, last_name, suffix, email, password, code, status)
                            values('$fname', '$mname', '$lname', '$suffix', '$email', '$encpass', '$code', '$status')";
            ...
            if($data_check){
                ...
                $mail->Username='saint.jude.colleges@gmail.com';
                $mail->Password='qweqwer123';

                $mail->setFrom('saint.jude.colleges@gmail.com', 'SaintJude');
                $mail->addAddress($email);
                $mail->addReplyTo('saint.jude.colleges@gmail.com');
    ...
    if(isset($_POST['login'])){
        ...
        if(mysqli_num_rows($res) > 0){
            ...
            $errors['email'] = "Ooopss! You just need to register first!.";
        }
    }
